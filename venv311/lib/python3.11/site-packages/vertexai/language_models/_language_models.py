...
import abc
import dataclasses
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertexai/language_models/_language_models.py
=======
import collections.abc
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertexai/language_models/_language_models.py
from typing import (
    Any,
    AsyncIterator,
    Dict,
