...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertexai/language_models/_distillation.py
...
class DistillationMixin:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertexai/language_models/_distillation.py
    def distill_from(
        self,
        *,
        dataset: str,
