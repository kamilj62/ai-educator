...
from vertexai.language_models._language_models import (
    ...
    ChatMessage,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertexai/preview/language_models.py
    ChatModel,
    ChatSession,
    CodeChatSession,
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertexai/preview/language_models.py
    CountTokensResponse,
    InputOutputTextPair,
    TextEmbedding,
    TextEmbeddingInput,
