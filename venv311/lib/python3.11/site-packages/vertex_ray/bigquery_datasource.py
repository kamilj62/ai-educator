...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertex_ray/bigquery_datasource.py
import logging
import os
import tempfile
import time
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertex_ray/bigquery_datasource.py
