...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertex_ray/util/resources.py
=======
...
@dataclasses.dataclass
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertex_ray/util/resources.py
class Resources:
