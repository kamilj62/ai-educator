...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/vertex_ray/__init__.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/vertex_ray/__init__.py
    create_ray_cluster,
    delete_ray_cluster,
    get_ray_cluster,
    list_ray_clusters,
