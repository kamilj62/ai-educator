...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/core/_utils.py
def _raise_warning(attr: str, submodule: str | None = None) -> None:
=======
def _raise_warning(attr: str, submodule: str = None) -> None:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/core/_utils.py
