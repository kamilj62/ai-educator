...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_expired_attrs_2_0.py
    "set_numeric_ops":
=======
    "set_numeric_ops": 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_expired_attrs_2_0.py
