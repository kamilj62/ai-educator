...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/strings/__init__.pyi
    equal,
    not_equal,
    greater_equal,
    less_equal,
...
__all__: list[str]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/strings/__init__.pyi
