    ...
    if 'map' in r:
        for k in r['map'].keys():
            if r['map'][k] in revmap:
                ...
                revmap[r['map'][k]] = k
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/use_rules.py
    if r.get('only'):
=======
    if 'only' in r and r['only']:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/use_rules.py
        for v in r['map'].keys():
