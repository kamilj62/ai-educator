...
@pytest.mark.slow
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_modules.py
...
@pytest.mark.slow
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_modules.py
