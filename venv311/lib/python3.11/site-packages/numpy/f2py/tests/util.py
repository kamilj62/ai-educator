...
import shutil
import atexit
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/util.py
=======
import textwrap
import re
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/util.py
import pytest
import contextlib
import numpy
