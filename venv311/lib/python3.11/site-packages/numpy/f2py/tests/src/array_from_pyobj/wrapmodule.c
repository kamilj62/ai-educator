...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/src/array_from_pyobj/wrapmodule.c
                       PyDataType_ALIGNMENT(PyArray_DESCR(arr)),
=======
                       PyDataType_ALIGNMENT(arr),
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/src/array_from_pyobj/wrapmodule.c
                       PyArray_FLAGS(arr),
                       PyArray_ITEMSIZE(arr));
}
