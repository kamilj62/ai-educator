<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
=======
import os
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
import sys
import copy
import platform
import pytest
