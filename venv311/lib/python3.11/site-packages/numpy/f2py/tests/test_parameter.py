<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_parameter.py
=======
import os
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_parameter.py
import pytest
