<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_f2py2e.py
import re
import shlex
import subprocess
import sys
...
from pathlib import Path
from collections import namedtuple
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_f2py2e.py
import platform
