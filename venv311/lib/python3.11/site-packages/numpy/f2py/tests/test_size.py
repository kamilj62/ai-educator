<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_size.py
=======
import os
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_size.py
import pytest
import numpy as np
