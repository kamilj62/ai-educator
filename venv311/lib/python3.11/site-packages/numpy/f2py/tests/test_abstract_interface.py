<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_abstract_interface.py
import pytest
=======
from pathlib import Path
import pytest
import textwrap
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_abstract_interface.py
from . import util
