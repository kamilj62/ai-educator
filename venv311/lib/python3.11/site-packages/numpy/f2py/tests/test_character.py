...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/tests/test_character.py
        expected = np.array([list(s) for s in a], dtype='u1')
=======
        expected = np.array([[c for c in s] for s in a], dtype='u1')
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/tests/test_character.py
