<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/__init__.py
=======
#!/usr/bin/env python3
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/__init__.py
