...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/f90mod_rules.py
=======
        contains_functions_or_subroutines = any(
            item for item in m["body"] if item["block"] in ["function", "subroutine"]
        )
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/f90mod_rules.py
