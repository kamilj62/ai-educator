    ...
    def compile(self):
        ...
        if self.sysinfo_flags:
            for n in self.sysinfo_flags:
                ...
                if not i:
                    print(
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/_backends/_distutils.py
                        f"No {n!r} resources found"
=======
                        f"No {repr(n)} resources found"
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/_backends/_distutils.py
