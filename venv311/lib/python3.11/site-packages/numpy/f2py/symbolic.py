...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/symbolic.py
...
=======
        if ((obj.op is Op.APPLY
             and obj.data[0] is ArithOp.DIV
             and not obj.data[2])):
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/symbolic.py
