...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/src/fortranobject.c
     * 'c', respectively).
=======
     * 'c', respecitely).
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/src/fortranobject.c
     *
