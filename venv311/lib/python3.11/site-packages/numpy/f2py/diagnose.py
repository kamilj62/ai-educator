...
def run():
    ...
    if has_numpy_distutils:
        ...
        try:
            ...
            print(
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/diagnose.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/diagnose.py
            print('------')
        try:
            if has_numpy_distutils == 2:
