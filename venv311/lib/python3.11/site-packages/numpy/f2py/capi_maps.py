                    ...
                    if 'map' in rout['use'][u]:
                        for k in rout['use'][u]['map'].keys():
                            if rout['use'][u]['map'][k] == un[0]:
                                ...
                                break
                    lcb_map[ln] = un[1]
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/f2py/capi_maps.py
    elif rout.get('externals'):
=======
    elif 'externals' in rout and rout['externals']:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/f2py/capi_maps.py
