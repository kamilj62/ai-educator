<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/tests/test_public_api.py
import functools
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/tests/test_public_api.py
import sys
import sysconfig
import subprocess
import pkgutil
