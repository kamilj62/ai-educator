...
import numpy as np
import pytest
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/tests/test_numpy_config.py
from unittest.mock import patch
=======
from unittest.mock import Mock, patch
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/tests/test_numpy_config.py
