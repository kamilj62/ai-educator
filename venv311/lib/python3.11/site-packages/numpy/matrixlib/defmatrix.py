...
def _convert_from_string(data):
    ...
    rows = data.split(';')
    newdata = []
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/matrixlib/defmatrix.py
    for count, row in enumerate(rows):
=======
    count = 0
    for row in rows:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/matrixlib/defmatrix.py
        trow = row.split(',')
        newrow = []
        for col in trow:
            temp = col.split()
