...
def get_overridable_numpy_ufuncs():
    ...
    return ufuncs
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/testing/overrides.py

=======
    
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/testing/overrides.py
