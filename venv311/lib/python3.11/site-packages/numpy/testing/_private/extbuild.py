...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/testing/_private/extbuild.py
    init = """
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/testing/_private/extbuild.py
           """
    if not build_dir:
        build_dir = pathlib.Path('.')
    if more_init:
