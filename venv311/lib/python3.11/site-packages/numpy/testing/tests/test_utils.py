...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/testing/tests/test_utils.py
        warn(UserWarning)  # should be suppressed
=======
        warn(UserWarning)  # should be supppressed
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/testing/tests/test_utils.py
        warn(RuntimeWarning)
