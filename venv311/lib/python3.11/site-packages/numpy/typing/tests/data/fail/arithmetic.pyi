...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/fail/arithmetic.pyi
AR_f: npt.NDArray[np.longdouble]
=======
AR_f: npt.NDArray[np.float64]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/fail/arithmetic.pyi
