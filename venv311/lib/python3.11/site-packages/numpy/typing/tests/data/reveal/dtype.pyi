<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/reveal/dtype.pyi
import ctypes as ct
...
if sys.version_info >= (3, 11):
    ...
    from typing_extensions import assert_type
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/reveal/dtype.pyi
