...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/pass/fromnumeric.py
np.cumulative_sum(a)
np.cumulative_sum(b)
np.cumulative_sum(c)
...
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/pass/fromnumeric.py
np.ptp(b)
np.ptp(c)
np.ptp(B)
np.ptp(B, axis=0)
