...
iterable_func(array)
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/pass/simple.py
list(array)
=======
[element for element in array]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/pass/simple.py
iter(array)
zip(array, array)
array[1]
array[:]
