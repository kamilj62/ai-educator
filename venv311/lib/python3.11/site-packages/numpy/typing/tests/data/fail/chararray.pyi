import numpy as np
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/fail/chararray.pyi
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/fail/chararray.pyi
