...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/pass/ufunclike.py
from typing import Any
=======
from typing import Any, Optional
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/pass/ufunclike.py
import numpy as np
