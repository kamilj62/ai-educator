<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/reveal/char.pyi
import numpy as np
...
assert_type(np.char.encode(AR_U), npt.NDArray[np.bytes_])
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/reveal/char.pyi
