...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/typing/tests/data/pass/array_like.py
...
import numpy as np
from numpy._typing import NDArray, ArrayLike, _SupportsArray
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/typing/tests/data/pass/array_like.py
