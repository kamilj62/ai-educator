...
from typing import (
    Literal as L,
    overload,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/linalg/_linalg.pyi
    TypeAlias,
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/linalg/_linalg.pyi
    TypeVar,
    Any,
    SupportsIndex,
    SupportsInt,
