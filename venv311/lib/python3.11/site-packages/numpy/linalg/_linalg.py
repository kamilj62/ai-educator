...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/linalg/_linalg.py
    amax, prod, abs, atleast_2d, intp, asanyarray, object_,
=======
    amax, prod, abs, atleast_2d, intp, asanyarray, object_, matmul,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/linalg/_linalg.py
