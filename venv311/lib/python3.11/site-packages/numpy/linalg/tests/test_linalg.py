...
import sys
import itertools
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/linalg/tests/test_linalg.py
import threading
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/linalg/tests/test_linalg.py
import traceback
import textwrap
import subprocess
import pytest
