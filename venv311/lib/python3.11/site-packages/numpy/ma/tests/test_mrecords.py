...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/ma/tests/test_mrecords.py
        assert_(mbase_last['a'] is masked)
=======
        assert_((mbase_last['a'] is masked))
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/ma/tests/test_mrecords.py
        # as slice ..........
        mbase_sl = mbase[:2]
