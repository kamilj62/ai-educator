...
class TestSubclassing:
    ...
    def test_subclasspreservation(self):
        ...
        x = np.arange(5)
        m = [0, 0, 1, 0, 0]
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/ma/tests/test_subclassing.py
        xinfo = list(zip(x, m))
=======
        xinfo = [(i, j) for (i, j) in zip(x, m)]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/ma/tests/test_subclassing.py
