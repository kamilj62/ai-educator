<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/ma/__init__.pyi
...
__all__: list[str]
test: PytestTester
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/ma/__init__.pyi
