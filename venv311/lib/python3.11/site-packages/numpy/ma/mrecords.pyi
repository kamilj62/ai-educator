...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/ma/mrecords.pyi
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/ma/mrecords.pyi
    def __new__(
        cls,
        shape,
        dtype=...,
