...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/tests/test_smoke.py
        assert_(type(self.rg) == type(unpick))
=======
        assert_((type(self.rg) == type(unpick)))
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/tests/test_smoke.py
