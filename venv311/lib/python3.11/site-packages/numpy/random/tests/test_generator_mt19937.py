...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/tests/test_generator_mt19937.py
        alpha = np.array([0.02, 0.04])
=======
        alpha = np.array([0.02, 0.04, 0.03])
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/tests/test_generator_mt19937.py
