...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/tests/test_generator_mt19937_regressions.py
...
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/tests/test_generator_mt19937_regressions.py
