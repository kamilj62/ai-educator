...
import os
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/tests/test_extending.py
=======
import pathlib
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/tests/test_extending.py
import pytest
import shutil
import subprocess
import sys
