<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/c_distributions.pxd
=======
#!python
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/c_distributions.pxd
