    ...
    with open(os.path.join(inc_dir, 'random', 'distributions.h')) as fid:
        ...
        for line in fid:
            ...
            if line.strip().startswith('#ifdef __cplusplus'):
                ignoring = True
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/_examples/cffi/parse.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/_examples/cffi/parse.py
