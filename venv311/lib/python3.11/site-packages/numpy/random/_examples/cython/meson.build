...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/_examples/cython/meson.build
base_cython_args = []
...
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/_examples/cython/meson.build
