...
from numpy import (
    dtype,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/mtrand.pyi
=======
    float32,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/mtrand.pyi
    float64,
    int8,
    int16,
    int32,
