<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/_pickle.py
=======
from __future__ import annotations

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/_pickle.py
