...
from typing import (
    Any,
    NamedTuple,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/random/bit_generator.pyi
    TypeAlias,
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/random/bit_generator.pyi
    TypedDict,
    TypeVar,
    overload,
    Literal,
