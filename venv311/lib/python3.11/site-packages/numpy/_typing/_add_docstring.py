...
add_newdoc('NDArray', repr(NDArray),
    """
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_typing/_add_docstring.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_typing/_add_docstring.py
