...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_typing/_char_codes.py
...
_TD64Codes = Literal[
    ...
    "m8[fs]", "=m8[fs]", "<m8[fs]", ">m8[fs]",
    "m8[as]", "=m8[as]", "<m8[as]", ">m8[as]",
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_typing/_char_codes.py
]
