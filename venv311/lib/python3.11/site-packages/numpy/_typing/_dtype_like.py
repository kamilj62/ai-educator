<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_typing/_dtype_like.py
...
from typing import (
    ...
    Sequence,
    Union,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_typing/_dtype_like.py
    TypeVar,
    Protocol,
    TypedDict,
    runtime_checkable,
