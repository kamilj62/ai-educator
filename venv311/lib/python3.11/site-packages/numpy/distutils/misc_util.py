...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/misc_util.py
...
=======
    for item in lst:
        if not is_string(item):
            return False
    return True
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/misc_util.py
