...
def _quote_arg(arg):
    ...
    """
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/exec_command.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/exec_command.py
