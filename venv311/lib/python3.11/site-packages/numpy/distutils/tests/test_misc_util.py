...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/tests/test_misc_util.py
import pytest

=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/tests/test_misc_util.py
