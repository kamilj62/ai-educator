...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/tests/test_build_ext.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/tests/test_build_ext.py
    build_dir = tmp_path
