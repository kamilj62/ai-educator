...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/intelccompiler.py
    cc_exe = 'icc'
=======
    ...
    for cc_exe in map(find_executable, ['icc', 'ecc']):
        if cc_exe:
            break
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/intelccompiler.py
