...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/distutils/extension.py
    ...
    def has_f2py_sources(self):
        for source in self.sources:
            if fortran_pyf_ext_re(source):
                return True
        return False
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/distutils/extension.py
