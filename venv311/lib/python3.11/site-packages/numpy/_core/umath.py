...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/umath.py
    _expandtabs, _center, _ljust, _rjust, _zfill, _partition, _partition_index,
    _rpartition, _rpartition_index)
=======
    _expandtabs)
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/umath.py
