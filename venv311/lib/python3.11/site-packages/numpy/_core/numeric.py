...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/numeric.py
    shares_memory, vdot, where, zeros, normalize_axis_index, vecdot
=======
    shares_memory, vdot, where, zeros, normalize_axis_index,
    _get_promotion_state, _set_promotion_state
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/numeric.py
)
