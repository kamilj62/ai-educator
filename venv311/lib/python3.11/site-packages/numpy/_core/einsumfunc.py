...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/einsumfunc.py
        positions, input_sets, output_set, idx_dict,
=======
        positions, input_sets, output_set, idx_dict, 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/einsumfunc.py
