...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/strings.py
from numpy._core.overrides import set_module
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/strings.py
