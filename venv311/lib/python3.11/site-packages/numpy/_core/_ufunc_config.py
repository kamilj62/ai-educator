...
"""
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/_ufunc_config.py
=======
import collections.abc
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/_ufunc_config.py
import contextlib
import contextvars
import functools
