...
class format_parser:
    ...
    Examples
    --------
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/records.py
    >>> import numpy as np
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/records.py
