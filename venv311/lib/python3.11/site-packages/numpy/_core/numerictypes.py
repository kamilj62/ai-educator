...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/numerictypes.py
        ndarray, dtype, datetime_data, datetime_as_string,
=======
        ndarray, array, dtype, datetime_data, datetime_as_string,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/numerictypes.py
