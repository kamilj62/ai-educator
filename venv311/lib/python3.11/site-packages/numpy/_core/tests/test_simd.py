...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_simd.py
import itertools
import math
import operator
import re
...
import itertools
import operator
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_simd.py
