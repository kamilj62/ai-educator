...
class TestFromrecords:
    ...
    def test_recarray_from_obj(self):
        ...
        for i in range(len(a)):
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_records.py
...
=======
            ...
            assert_((mine.data1[i] == 0.0))
            assert_((mine.data2[i] == 0.0))
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_records.py
