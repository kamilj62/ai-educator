...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_function_base.py
        # test the shortest logarithmic spiral is used, see gh-25644
=======
        # test the shortest logorithmic spiral is used, see gh-25644
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_function_base.py
        x = 1.2 + 3.4j
