...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_scalarinherit.py
    def test_int_repr(self):
        ...
        assert s == "my_int16(3)"
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_scalarinherit.py
