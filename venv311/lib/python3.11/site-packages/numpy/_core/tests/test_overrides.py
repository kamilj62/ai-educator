...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_overrides.py
from numpy.testing.overrides import get_overridable_numpy_array_functions
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_overrides.py
