...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_stringdtype.py
from numpy.testing import assert_array_equal, IS_WASM, IS_PYPY
=======
from numpy.testing import assert_array_equal, IS_WASM
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_stringdtype.py
