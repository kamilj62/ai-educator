...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_ufunc.py
UNARY_OBJECT_UFUNCS.remove(np.bitwise_count)
=======
UNARY_OBJECT_UFUNCS.remove(getattr(np, 'bitwise_count'))
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_ufunc.py
