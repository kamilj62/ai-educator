...
"""
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_deprecations.py
=======
import datetime
import operator
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_deprecations.py
import warnings
import pytest
import tempfile
import re
