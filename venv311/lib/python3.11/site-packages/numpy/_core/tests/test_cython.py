...
import os
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_cython.py
import subprocess
import sys
import pytest
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_cython.py
