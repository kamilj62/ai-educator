...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_indexing.py
        # a non-contiguous none 1D array here.
=======
        # a non-contiuguous none 1D array here.
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_indexing.py
        a[idx] = -1
        res = np.arange(6)
        res[0] = -1
        res[3] = -1
