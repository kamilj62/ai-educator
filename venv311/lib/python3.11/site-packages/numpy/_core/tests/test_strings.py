...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_strings.py
from numpy.testing._private.utils import requires_memory
=======

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_strings.py
