...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_numeric.py
=======
from numpy._core.arrayprint import set_string_function
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_numeric.py
