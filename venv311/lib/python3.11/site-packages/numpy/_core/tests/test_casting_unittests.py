...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_casting_unittests.py
    def test_structured_view_offsets_parametric(
=======
    def test_structured_view_offsets_paramteric(
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_casting_unittests.py
