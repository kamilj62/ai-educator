<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_cpu_features.py
import os
import re
import sys
import pathlib
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_cpu_features.py
