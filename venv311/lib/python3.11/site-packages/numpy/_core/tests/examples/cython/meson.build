...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/examples/cython/meson.build
cython_args = []
...
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/examples/cython/meson.build
