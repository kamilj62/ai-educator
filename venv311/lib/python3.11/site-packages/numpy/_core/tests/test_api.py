...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_api.py
    np._core.sctypes['uint'] +
    np._core.sctypes['int'] +
=======
    np._core.sctypes['uint'] + 
    np._core.sctypes['int'] + 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_api.py
