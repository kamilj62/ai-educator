...
class TestRegression:
    ...
    def test_rec_iterate(self):
        ...
        x[0].tolist()
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_regression.py
        list(x[0])
=======
        [i for i in x[0]]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_regression.py
