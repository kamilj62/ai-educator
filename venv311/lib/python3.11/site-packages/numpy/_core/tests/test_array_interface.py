...
import pytest
import numpy as np
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_array_interface.py
from numpy.testing import extbuild, IS_WASM, IS_EDITABLE
=======
from numpy.testing import extbuild, IS_WASM
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_array_interface.py
