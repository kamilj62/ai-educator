import os
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_limited_api.py
=======
import shutil
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_limited_api.py
import subprocess
import sys
import sysconfig
import pytest
