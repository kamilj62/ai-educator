...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/_locales.py
=======
    .. versionadded:: 1.15.0

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/_locales.py
    """
