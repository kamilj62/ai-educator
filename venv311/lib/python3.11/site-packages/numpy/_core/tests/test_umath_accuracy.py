...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/tests/test_umath_accuracy.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/tests/test_umath_accuracy.py
