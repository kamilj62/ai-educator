...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/function_base.py
=======
    .. versionchanged:: 1.16.0
        Non-scalar `start` and `stop` are now supported.

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/function_base.py
