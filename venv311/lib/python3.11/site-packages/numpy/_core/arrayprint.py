...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/arrayprint.py
                         datetime_as_string, datetime_data, ndarray)
=======
                         datetime_as_string, datetime_data, ndarray,
                         set_legacy_print_mode)
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/arrayprint.py
