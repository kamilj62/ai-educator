...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/function_base.pyi
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/function_base.pyi
@overload
def linspace(
