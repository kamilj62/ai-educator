from typing import (
    Literal as L,
    overload,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/defchararray.pyi
    TypeAlias,
    TypeVar,
    Any,
    SupportsIndex,
=======
    ...
    Any,
    SupportsIndex, 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/defchararray.pyi
    SupportsInt,
)
