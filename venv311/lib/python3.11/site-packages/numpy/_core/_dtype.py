...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/_dtype.py
    return total_offset == dtype.itemsize
=======
    if total_offset != dtype.itemsize:
        return False
    return True
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/_dtype.py
