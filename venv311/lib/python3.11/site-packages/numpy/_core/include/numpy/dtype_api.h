 ...
 * The function must clean up on error.
 *
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/include/numpy/dtype_api.h
 * @param nin Number of input arguments
 * @param nout Number of output arguments
=======
 * @param nargs Number of arguments
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/include/numpy/dtype_api.h
