...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/include/numpy/npy_2_compat.h
   * compile for both 1.x and 2.x (defining it guarantees 1.x only).
=======
   * compile for both 1.x and 2.x (defining it gaurantees 1.x only).
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/include/numpy/npy_2_compat.h
   */
