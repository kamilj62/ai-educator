...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/include/numpy/__ufunc_api.h
...
#if defined(PY_UFUNC_UNIQUE_SYMBOL)
void **PyUFunc_API;
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/include/numpy/__ufunc_api.h
#else
