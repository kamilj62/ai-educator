...
{
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/include/numpy/npy_math.h
...
=======
    return ((double *) &z)[0];
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/include/numpy/npy_math.h
}
