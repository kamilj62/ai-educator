...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/_core/_machar.py
        # underflow to detect the properties of the running arch.
=======
        # underflow to detect the properties of the runninng arch.
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/_core/_machar.py
