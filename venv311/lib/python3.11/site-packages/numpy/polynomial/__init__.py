...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/__init__.py
    >>> xdata = [1, 2, 3, 4]
    >>> ydata = [1, 4, 9, 16]
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/__init__.py
