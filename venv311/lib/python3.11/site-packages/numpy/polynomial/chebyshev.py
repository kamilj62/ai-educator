...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/chebyshev.py
    See Also
    --------
...
=======
    ...
    .. versionadded:: 1.5.0
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/chebyshev.py
