...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/hermite.py
=======
        .. versionadded:: 1.7.0

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/hermite.py
    Returns
    -------
    der : ndarray
