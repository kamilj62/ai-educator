...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/_polybase.py
=======
    .. versionadded:: 1.9.0

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/_polybase.py
    Parameters
    ----------
    coef : array_like
