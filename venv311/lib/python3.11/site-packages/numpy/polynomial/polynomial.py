...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/polynomial.py
=======
    Notes
    -----
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/polynomial.py
    Examples
    --------
    >>> from numpy.polynomial import polynomial as P
    >>> c = (1, 2, 3)
