...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/tests/test_legendre.py
                res = leg.legpow(c, j)
=======
                res = leg.legpow(c, j) 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/tests/test_legendre.py
                assert_equal(trim(res), trim(tgt), err_msg=msg)
