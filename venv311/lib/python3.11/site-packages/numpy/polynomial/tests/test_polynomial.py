...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/tests/test_polynomial.py
import numpy.polynomial.polyutils as pu
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/tests/test_polynomial.py
import pickle
