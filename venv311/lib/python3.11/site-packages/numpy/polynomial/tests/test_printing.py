...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/tests/test_printing.py
    The exponential notation is enabled automatically when the values
=======
    The exponential notation is enabled automatically when the values 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/tests/test_printing.py
