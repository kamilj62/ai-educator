...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/tests/test_hermite.py
                res = herm.hermpow(c, j)
=======
                res = herm.hermpow(c, j) 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/tests/test_hermite.py
                assert_equal(trim(res), trim(tgt), err_msg=msg)
