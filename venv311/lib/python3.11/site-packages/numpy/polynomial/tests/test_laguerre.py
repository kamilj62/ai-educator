...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/tests/test_laguerre.py
                res = lag.lagpow(c, j)
=======
                res = lag.lagpow(c, j) 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/tests/test_laguerre.py
                assert_equal(trim(res), trim(tgt), err_msg=msg)
