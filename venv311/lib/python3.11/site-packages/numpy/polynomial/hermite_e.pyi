<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/polynomial/hermite_e.pyi
...
class HermiteE(ABCPolyBase):
    ...
    window: Any
    basis_name: Any
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/polynomial/hermite_e.pyi
