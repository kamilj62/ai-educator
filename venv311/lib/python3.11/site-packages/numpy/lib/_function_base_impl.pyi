<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_function_base_impl.pyi
...
from typing import (
    Literal as L,
    Any,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_function_base_impl.pyi
    TypeVar,
    overload,
    Protocol,
    SupportsIndex,
