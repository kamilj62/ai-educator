...
class Arrayterator:
    ...
    Examples
    --------
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_arrayterator_impl.py
    >>> import numpy as np
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_arrayterator_impl.py
