...
class DataSource:
    ...
    def _iswritemode(self, mode):
        ...
        _writemodes = ("w", "+")
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_datasource.py
...
=======
        for c in mode:
            if c in _writemodes:
                return True
        return False
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_datasource.py
