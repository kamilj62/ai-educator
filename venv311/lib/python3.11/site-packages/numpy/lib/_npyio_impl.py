...
import contextlib
import operator
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_npyio_impl.py
from operator import itemgetter
=======
from operator import itemgetter, index as opindex, methodcaller
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_npyio_impl.py
