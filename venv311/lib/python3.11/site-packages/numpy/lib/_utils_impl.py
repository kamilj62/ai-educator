...
import textwrap
import types
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_utils_impl.py
=======
import re
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_utils_impl.py
import warnings
import functools
import platform
