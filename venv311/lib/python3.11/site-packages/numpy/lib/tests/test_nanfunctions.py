...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/tests/test_nanfunctions.py
            pytest.skip("`axis != None` not supported for 0d arrays")
=======
            pytest.skip(f"`axis != None` not supported for 0d arrays")
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/tests/test_nanfunctions.py
