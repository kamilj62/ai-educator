...
def test_version_2_0_memmap(tmpdir):
    ...
    dt = [(("%d" % i) * 100, float) for i in range(500)]
    d = np.ones(1000, dtype=dt)
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/tests/test_format.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/tests/test_format.py
