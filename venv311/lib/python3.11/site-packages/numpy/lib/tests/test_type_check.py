...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/tests/test_type_check.py
...
=======
        ...
        with np.errstate(divide='ignore', invalid='ignore'):
            vals = nan_to_num(np.array((-1., 0, 1))/0., 
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/tests/test_type_check.py
