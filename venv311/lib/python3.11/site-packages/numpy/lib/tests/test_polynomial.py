...
class TestPolynomial:
    ...
    def test_poly_eq(self):
        p = np.poly1d([1, 2, 3])
        p2 = np.poly1d([1, 2, 4])
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/tests/test_polynomial.py
        assert_equal(p == None, False)  # noqa: E711
        assert_equal(p != None, True)  # noqa: E711
=======
        assert_equal(p == None, False)
        assert_equal(p != None, True)
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/tests/test_polynomial.py
