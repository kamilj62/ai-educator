...
def test_scientific_notation():
    ...
    data = StringIO(
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/tests/test_loadtxt.py

=======
        (
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/tests/test_loadtxt.py
            "1.0e-1,2.0E1,3.0\n"
            "4.0e-2,5.0E-1,6.0\n"
            "7.0e-3,8.0E1,9.0\n"
            "0.0e-4,1.0E-1,2.0"
