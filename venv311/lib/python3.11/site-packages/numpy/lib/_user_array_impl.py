...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_user_array_impl.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_user_array_impl.py
class container:
    """
