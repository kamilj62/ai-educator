...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_scimath_impl.pyi
__all__ = ["sqrt", "log", "log2", "logn", "log10", "power", "arccos", "arcsin", "arctanh"]
=======
__all__: list[str]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_scimath_impl.pyi
