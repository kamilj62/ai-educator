...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_type_check_impl.pyi
...
from numpy import (
    ...
    floating,
    float64,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_type_check_impl.pyi
    complexfloating,
    integer,
)
