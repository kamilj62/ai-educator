from typing import (
    Literal as L,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_polynomial_impl.pyi
    TypeAlias,
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_polynomial_impl.pyi
    overload,
    Any,
    SupportsInt,
    SupportsIndex,
