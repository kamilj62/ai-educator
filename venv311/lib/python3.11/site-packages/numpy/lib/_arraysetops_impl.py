...
def ediff1d(ary, to_end=None, to_begin=None):
    ...
    Examples
    --------
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/_arraysetops_impl.py
    >>> import numpy as np
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/_arraysetops_impl.py
