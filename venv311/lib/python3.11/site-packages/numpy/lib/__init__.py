...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/__init__.py
add_newdoc.__module__ = "numpy.lib"

=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/__init__.py
