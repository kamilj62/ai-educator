<<<<<<< HEAD:venv311/lib/python3.11/site-packages/numpy/lib/format.pyi
...
__all__: list[str]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/numpy/lib/format.pyi
