...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/cachecontrol/adapter.py
    def build_response(
=======
    def build_response(  # type: ignore[override]
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/cachecontrol/adapter.py
        self,
        request: PreparedRequest,
