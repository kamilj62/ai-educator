...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/tomli/_parser.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/tomli/_parser.py
from ._re import (
    RE_DATETIME,
    RE_LOCALTIME,
    RE_NUMBER,
