...
class ReprHighlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        _combine_regex(
            ...
            r"(?<![\\\w])(?P<str>b?'''.*?(?<!\\)'''|b?'.*?(?<!\\)'|b?\"\"\".*?(?<!\\)\"\"\"|b?\".*?(?<!\\)\")",
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/rich/highlighter.py
            r"(?P<url>(file|https|http|ws|wss)://[-0-9a-zA-Z$_+!`(),.?/;:&=%#~]*)",
=======
            r"(?P<url>(file|https|http|ws|wss)://[-0-9a-zA-Z$_+!`(),.?/;:&=%#~@]*)",
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/rich/highlighter.py
        ),
    ]
