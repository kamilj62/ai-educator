...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/rich/prompt.py
=======
        case_sensitive (bool, optional): Matching of choices should be case-sensitive. Defaults to True.
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/rich/prompt.py
