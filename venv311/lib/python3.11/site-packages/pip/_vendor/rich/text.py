...
from typing import (
    ...
    NamedTuple,
    Optional,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/rich/text.py
=======
    Pattern,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/rich/text.py
    Tuple,
    Union,
)
