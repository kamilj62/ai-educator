...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/rich/tree.py
=======
GuideType = Tuple[str, str, str, str]

>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/rich/tree.py
