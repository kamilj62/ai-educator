import os.path
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/rich/syntax.py
import platform
=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/rich/syntax.py
import re
import sys
import textwrap
