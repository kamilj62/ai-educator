...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_vendor/pyproject_hooks/_impl.py
...
def read_json(path: str) -> Mapping[str, Any]:
    with open(path, encoding="utf-8") as f:
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_vendor/pyproject_hooks/_impl.py
        return json.load(f)
