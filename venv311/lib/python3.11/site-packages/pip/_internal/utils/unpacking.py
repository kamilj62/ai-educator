...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_internal/utils/unpacking.py
    tar = tarfile.open(filename, mode, encoding="utf-8")
=======
    tar = tarfile.open(filename, mode, encoding="utf-8")  # type: ignore
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_internal/utils/unpacking.py
    try:
