...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_internal/utils/logging.py
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_internal/utils/logging.py
            show_time=False,
            show_level=False,
            show_path=False,
