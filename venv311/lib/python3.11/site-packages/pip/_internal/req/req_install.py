...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_internal/req/req_install.py
                gone_in="25.0",
=======
                gone_in="25.1",
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_internal/req/req_install.py
                issue=11457,
            )
            if self.config_settings:
                logger.warning(
