...
import pathlib
import zipfile
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/pip/_internal/metadata/importlib/_dists.py
=======
from os import PathLike
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/pip/_internal/metadata/importlib/_dists.py
from typing import (
    Collection,
    Dict,
    Iterable,
