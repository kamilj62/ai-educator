...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/utils/prediction_utils.py
        shutil.copytree(artifact_uri, ".")
=======
        shutil.copytree(artifact_uri, ".", dirs_exist_ok=True)
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/utils/prediction_utils.py
