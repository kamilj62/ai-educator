...
class VertexLogger(logging.getLoggerClass()):
    ...
    def log_create_complete(
        ...
        variable_name: str,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/base.py
=======
        *,
        module_name: str = "aiplatform",
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/base.py
    ):
