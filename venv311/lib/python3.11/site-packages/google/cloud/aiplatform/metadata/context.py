...
class Context(resource._Resource):
    ...
    def update(
        ...
        description: Optional[str] = None,
        credentials: Optional[auth_credentials.Credentials] = None,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/metadata/context.py
=======
        location: Optional[str] = None,
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/metadata/context.py
    ):
