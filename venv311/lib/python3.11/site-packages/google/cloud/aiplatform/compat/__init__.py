...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/compat/__init__.py
=======
    services.feature_registry_service_client = (
        services.feature_registry_service_client_v1beta1
    )
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/compat/__init__.py
