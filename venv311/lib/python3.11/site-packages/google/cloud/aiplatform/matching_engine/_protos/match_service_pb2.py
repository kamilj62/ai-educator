# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/matching_engine/_protos/match_service_pb2.py

=======
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/matching_engine/_protos/match_service_pb2.py
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _NUMERICNAMESPACE._serialized_end = 2156
    _NUMERICNAMESPACE_OPERATOR._serialized_start = 2042
    _NUMERICNAMESPACE_OPERATOR._serialized_end = 2147
    _MATCHSERVICE._serialized_start = 2159
    _MATCHSERVICE._serialized_end = 2577
=======
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
