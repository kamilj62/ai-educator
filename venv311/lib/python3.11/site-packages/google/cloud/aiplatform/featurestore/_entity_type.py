...
import datetime
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/featurestore/_entity_type.py
from typing import Dict, List, Optional, Sequence, Tuple, Union
=======
from typing import Dict, List, Optional, Sequence, Tuple, TYPE_CHECKING, Union
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/featurestore/_entity_type.py
import uuid
