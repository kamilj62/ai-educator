...
SUPPORTED_REGIONS = frozenset(
    {
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform/constants/base.py
=======
        "africa-south1",
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform/constants/base.py
        "asia-east1",
        "asia-east2",
        "asia-northeast1",
        "asia-northeast2",
