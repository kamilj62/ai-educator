# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/tensorboard_data.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/tensorboard_data.py
#
...
class TimeSeriesData(proto.Message):
    ...
    Attributes:
        ...
        values (MutableSequence[google.cloud.aiplatform_v1.types.TimeSeriesDataPoint]):
...
class TensorboardBlobSequence(proto.Message):
    ...
    Attributes:
        values (MutableSequence[google.cloud.aiplatform_v1.types.TensorboardBlob]):
