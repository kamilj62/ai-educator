# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/nas_job.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/nas_job.py
#
...
class NasJob(proto.Message):
    ...
    Attributes:
        ...
        nas_job_spec (google.cloud.aiplatform_v1.types.NasJobSpec):
            Required. The specification of a NasJob.
        nas_job_output (google.cloud.aiplatform_v1.types.NasJobOutput):
...
class NasJobSpec(proto.Message):
    ...
    Attributes:
        multi_trial_algorithm_spec (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec):
    ...
    class MultiTrialAlgorithmSpec(proto.Message):
        ...
        Attributes:
            multi_trial_algorithm (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec.MultiTrialAlgorithm):
                The multi-trial Neural Architecture Search (NAS) algorithm
                type. Defaults to ``REINFORCEMENT_LEARNING``.
            metric (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec):
                Metric specs for the NAS job. Validation for this field is
                done at ``multi_trial_algorithm_spec`` field.
            search_trial_spec (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec.SearchTrialSpec):
                Required. Spec for search trials.
            train_trial_spec (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec.TrainTrialSpec):
        ...
        class MetricSpec(proto.Message):
            ...
            Attributes:
                metric_id (str):
                    ...
                    contain whitespaces.
                goal (google.cloud.aiplatform_v1.types.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec.GoalType):
        ...
        class TrainTrialSpec(proto.Message):
            ...
            Attributes:
                train_trial_job_spec (google.cloud.aiplatform_v1.types.CustomJobSpec):
...
class NasJobOutput(proto.Message):
    ...
    Attributes:
        multi_trial_job_output (google.cloud.aiplatform_v1.types.NasJobOutput.MultiTrialJobOutput):
    ...
    class MultiTrialJobOutput(proto.Message):
        ...
        Attributes:
            search_trials (MutableSequence[google.cloud.aiplatform_v1.types.NasTrial]):
                Output only. List of NasTrials that were
                started as part of search stage.
            train_trials (MutableSequence[google.cloud.aiplatform_v1.types.NasTrial]):
                Output only. List of NasTrials that were
...
class NasTrial(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.aiplatform_v1.types.NasTrial.State):
