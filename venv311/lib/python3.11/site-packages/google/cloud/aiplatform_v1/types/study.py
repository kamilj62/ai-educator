# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/study.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/study.py
#
...
class StudySpec(proto.Message):
    ...
    Attributes:
        ...
        measurement_selection_type (google.cloud.aiplatform_v1.types.StudySpec.MeasurementSelectionType):
            ...
            will be used
        study_stopping_config (google.cloud.aiplatform_v1.types.StudySpec.StudyStoppingConfig):
    ...
    class StudyStoppingConfig(proto.Message):
        ...
        Attributes:
            should_stop_asap (google.protobuf.wrappers_pb2.BoolValue):
                ...
                the source of truth).
            minimum_runtime_constraint (google.cloud.aiplatform_v1.types.StudyTimeConstraint):
            ...
            maximum_runtime_constraint (google.cloud.aiplatform_v1.types.StudyTimeConstraint):
