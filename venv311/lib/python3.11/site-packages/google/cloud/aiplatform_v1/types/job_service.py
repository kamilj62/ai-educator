# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/job_service.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/job_service.py
#
...
class ListCustomJobsResponse(proto.Message):
    ...
    Attributes:
        custom_jobs (MutableSequence[google.cloud.aiplatform_v1.types.CustomJob]):
...
class ListHyperparameterTuningJobsResponse(proto.Message):
    ...
    Attributes:
        hyperparameter_tuning_jobs (MutableSequence[google.cloud.aiplatform_v1.types.HyperparameterTuningJob]):
...
class ListNasTrialDetailsResponse(proto.Message):
    ...
    Attributes:
        nas_trial_details (MutableSequence[google.cloud.aiplatform_v1.types.NasTrialDetail]):
...
class SearchModelDeploymentMonitoringStatsAnomaliesRequest(proto.Message):
    ...
    Attributes:
        ...
        objectives (MutableSequence[google.cloud.aiplatform_v1.types.SearchModelDeploymentMonitoringStatsAnomaliesRequest.StatsAnomaliesObjective]):
...
class SearchModelDeploymentMonitoringStatsAnomaliesResponse(proto.Message):
    ...
    Attributes:
        monitoring_stats (MutableSequence[google.cloud.aiplatform_v1.types.ModelMonitoringStatsAnomalies]):
...
class ListModelDeploymentMonitoringJobsResponse(proto.Message):
    ...
    Attributes:
        model_deployment_monitoring_jobs (MutableSequence[google.cloud.aiplatform_v1.types.ModelDeploymentMonitoringJob]):
