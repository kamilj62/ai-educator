# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/model_evaluation_slice.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/model_evaluation_slice.py
#
    ...
    class Slice(proto.Message):
        ...
        Attributes:
            ...
            value (str):
                ...
                this slice.
            slice_spec (google.cloud.aiplatform_v1.types.ModelEvaluationSlice.Slice.SliceSpec):
        ...
        class SliceSpec(proto.Message):
            ...
            Attributes:
                configs (MutableMapping[str, google.cloud.aiplatform_v1.types.ModelEvaluationSlice.Slice.SliceSpec.SliceConfig]):
            ...
            class SliceConfig(proto.Message):
                ...
                Attributes:
                    value (google.cloud.aiplatform_v1.types.ModelEvaluationSlice.Slice.SliceSpec.Value):
                        A unique specific value for a given feature. Example:
                        ``{ "value": { "string_value": "12345" } }``

                        This field is a member of `oneof`_ ``kind``.
                    range_ (google.cloud.aiplatform_v1.types.ModelEvaluationSlice.Slice.SliceSpec.Range):
