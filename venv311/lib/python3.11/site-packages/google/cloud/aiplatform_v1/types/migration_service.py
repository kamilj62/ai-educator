# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/migration_service.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/migration_service.py
#
...
class SearchMigratableResourcesResponse(proto.Message):
    ...
    Attributes:
        migratable_resources (MutableSequence[google.cloud.aiplatform_v1.types.MigratableResource]):
    ...
    class MigrateDataLabelingDatasetConfig(proto.Message):
        ...
        Attributes:
            ...
            dataset_display_name (str):
                ...
                Vertex AI. System will pick a display name if
                unspecified.
            migrate_data_labeling_annotated_dataset_configs (MutableSequence[google.cloud.aiplatform_v1.types.MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig]):
...
class BatchMigrateResourcesResponse(proto.Message):
    ...
    Attributes:
        migrate_resource_responses (MutableSequence[google.cloud.aiplatform_v1.types.MigrateResourceResponse]):
...
class BatchMigrateResourcesOperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        partial_results (MutableSequence[google.cloud.aiplatform_v1.types.BatchMigrateResourcesOperationMetadata.PartialResult]):
