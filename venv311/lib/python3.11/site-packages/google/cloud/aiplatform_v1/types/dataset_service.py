# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/types/dataset_service.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/types/dataset_service.py
#
...
class SearchDataItemsRequest(proto.Message):
    ...
    Attributes:
        ...
        order_by_annotation (google.cloud.aiplatform_v1.types.SearchDataItemsRequest.OrderByAnnotation):
