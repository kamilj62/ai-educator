# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/services/deployment_resource_pool_service/transports/grpc.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/deployment_resource_pool_service/transports/grpc.py
#
...
class DeploymentResourcePoolServiceGrpcTransport(
    ...
    """gRPC backend transport for DeploymentResourcePoolService.
...
__all__ = ("DeploymentResourcePoolServiceGrpcTransport",)
