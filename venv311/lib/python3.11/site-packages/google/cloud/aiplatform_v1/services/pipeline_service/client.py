# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/services/pipeline_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/pipeline_service/client.py
#
...
class PipelineServiceClient(metaclass=PipelineServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or PipelineServiceClient._compare_universes(
...
=======
    def batch_delete_pipeline_jobs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.BatchDeletePipelineJobsRequest, dict]):
                The request object. Request message for
...
=======
    def batch_cancel_pipeline_jobs(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.BatchCancelPipelineJobsRequest, dict]):
                The request object. Request message for
