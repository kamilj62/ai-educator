# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/services/match_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/match_service/client.py
#
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/match_service/client.py
    ...
    def find_neighbors(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.FindNeighborsRequest, dict]):
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/match_service/client.py
    ...
    def read_index_datapoints(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1.types.ReadIndexDatapointsRequest, dict]):
                The request object. The request message for
