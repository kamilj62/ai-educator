# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1/services/vizier_service/pagers.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1/services/vizier_service/pagers.py
#
...
class ListStudiesPager:
    ...
    All the usual :class:`google.cloud.aiplatform_v1.types.ListStudiesResponse`
...
class ListTrialsPager:
    ...
    All the usual :class:`google.cloud.aiplatform_v1.types.ListTrialsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
