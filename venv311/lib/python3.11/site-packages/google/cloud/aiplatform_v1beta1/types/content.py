# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/types/content.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/types/content.py
#
...
=======
    ...
    class RoutingConfig(proto.Message):
        ...
        class AutoRoutingMode(proto.Message):
            ...
            Attributes:
                model_routing_preference (google.cloud.aiplatform_v1beta1.types.GenerationConfig.RoutingConfig.AutoRoutingMode.ModelRoutingPreference):
...
=======
        avg_logprobs (float):
            ...
            the candidate.
        logprobs_result (google.cloud.aiplatform_v1beta1.types.LogprobsResult):
...
class LogprobsResult(proto.Message):
    ...
    Attributes:
        top_candidates (MutableSequence[google.cloud.aiplatform_v1beta1.types.LogprobsResult.TopCandidates]):
            Length = total number of decoding steps.
        chosen_candidates (MutableSequence[google.cloud.aiplatform_v1beta1.types.LogprobsResult.Candidate]):
    ...
    class TopCandidates(proto.Message):
        ...
        Attributes:
            candidates (MutableSequence[google.cloud.aiplatform_v1beta1.types.LogprobsResult.Candidate]):
...
=======
        ...
        retrieval_queries (MutableSequence[str]):
            ...
            tools.
        grounding_chunks (MutableSequence[google.cloud.aiplatform_v1beta1.types.GroundingChunk]):
