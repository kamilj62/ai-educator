# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/types/feature_online_store.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/types/feature_online_store.py
#
...
class FeatureOnlineStore(proto.Message):
    ...
    Attributes:
        bigtable (google.cloud.aiplatform_v1beta1.types.FeatureOnlineStore.Bigtable):
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/types/feature_online_store.py
        ...
        Attributes:
            enabled (bool):
                Optional. Immutable. Whether to enable
                embedding management in this FeatureOnlineStore.
                It's immutable after creation to ensure the
