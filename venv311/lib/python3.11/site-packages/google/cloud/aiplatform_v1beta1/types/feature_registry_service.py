# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/types/feature_registry_service.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/types/feature_registry_service.py
#
...
class ListFeatureGroupsResponse(proto.Message):
    ...
    Attributes:
        feature_groups (MutableSequence[google.cloud.aiplatform_v1beta1.types.FeatureGroup]):
