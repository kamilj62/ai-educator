# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/feature_online_store_service/transports/grpc_asyncio.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_online_store_service/transports/grpc_asyncio.py
#
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_online_store_service/transports/grpc_asyncio.py
    ...
    def fetch_feature_values(
        ...
        r"""Return a callable for the fetch feature values method over gRPC.

        Fetch feature values under a FeatureView.

        Returns:
            Callable[[~.FetchFeatureValuesRequest],
                    Awaitable[~.FetchFeatureValuesResponse]]:
        ...
        if "fetch_feature_values" not in self._stubs:
            self._stubs["fetch_feature_values"] = self.grpc_channel.unary_unary(
                "/google.cloud.aiplatform.v1beta1.FeatureOnlineStoreService/FetchFeatureValues",
                request_serializer=feature_online_store_service.FetchFeatureValuesRequest.serialize,
...
=======
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.fetch_feature_values: self._wrap_method(
                self.fetch_feature_values,
                default_timeout=None,
                client_info=client_info,
            ),
            self.streaming_fetch_feature_values: self._wrap_method(
                self.streaming_fetch_feature_values,
                default_timeout=None,
                client_info=client_info,
            ),
            self.search_nearest_entities: self._wrap_method(
...
__all__ = ("FeatureOnlineStoreServiceGrpcAsyncIOTransport",)
