# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/index_endpoint_service/transports/grpc_asyncio.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/index_endpoint_service/transports/grpc_asyncio.py
#
...
=======
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_index_endpoint: self._wrap_method(
                self.create_index_endpoint,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.get_index_endpoint: self._wrap_method(
                self.get_index_endpoint,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.list_index_endpoints: self._wrap_method(
                self.list_index_endpoints,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.update_index_endpoint: self._wrap_method(
                self.update_index_endpoint,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.delete_index_endpoint: self._wrap_method(
                self.delete_index_endpoint,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.deploy_index: self._wrap_method(
                self.deploy_index,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.undeploy_index: self._wrap_method(
                self.undeploy_index,
                default_timeout=5.0,
                client_info=client_info,
            ),
            self.mutate_deployed_index: self._wrap_method(
