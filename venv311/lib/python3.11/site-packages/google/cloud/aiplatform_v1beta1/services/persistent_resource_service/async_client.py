# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
#
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return PersistentResourceServiceClient.from_service_account_info.__func__(PersistentResourceServiceAsyncClient, info, *args, **kwargs)  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            PersistentResourceServiceAsyncClient: The constructed client.
        """
        return PersistentResourceServiceClient.from_service_account_file.__func__(PersistentResourceServiceAsyncClient, filename, *args, **kwargs)  # type: ignore
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return PersistentResourceServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> PersistentResourceServiceTransport:
        ...
        Returns:
            PersistentResourceServiceTransport: The transport used by the client instance.
        """
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
    ...
    async def create_persistent_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CreatePersistentResourceRequest, dict]]):
            ...
            persistent_resource (:class:`google.cloud.aiplatform_v1beta1.types.PersistentResource`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            persistent_resource_id (:class:`str`):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_persistent_resource():
                ...
                # Make the request
                response = await client.get_persistent_resource(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.GetPersistentResourceRequest, dict]]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
    ...
    async def list_persistent_resources(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.ListPersistentResourcesRequest, dict]]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/persistent_resource_service/async_client.py
    ...
    async def delete_persistent_resource(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.DeletePersistentResourceRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_reboot_persistent_resource():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.RebootPersistentResourceRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.RebootPersistentResourceRequest, dict]]):
                The request object. Request message for
