# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/tensorboard_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/tensorboard_service/client.py
#
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/tensorboard_service/client.py
    ...
    def read_tensorboard_usage(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ReadTensorboardUsageRequest, dict]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/tensorboard_service/client.py
    ...
    def read_tensorboard_size(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ReadTensorboardSizeRequest, dict]):
                The request object. Request message for
