# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/schedule_service/pagers.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/schedule_service/pagers.py
#
...
class ListSchedulesPager:
    ...
    :class:`google.cloud.aiplatform_v1beta1.types.ListSchedulesResponse` object, and
    ...
    All the usual :class:`google.cloud.aiplatform_v1beta1.types.ListSchedulesResponse`
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/schedule_service/pagers.py
        ...
        Args:
            ...
            request (google.cloud.aiplatform_v1beta1.types.ListSchedulesRequest):
                The initial request object.
            response (google.cloud.aiplatform_v1beta1.types.ListSchedulesResponse):
