# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
#
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
    ...
    def create_feature_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.CreateFeatureGroupRequest, dict]):
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.aiplatform_v1beta1.types.FeatureGroup`
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
    ...
    def get_feature_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetFeatureGroupRequest, dict]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
    ...
    def list_feature_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListFeatureGroupsRequest, dict]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
    ...
    def update_feature_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateFeatureGroupRequest, dict]):
                The request object. Request message for
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/feature_registry_service/client.py
    ...
    def delete_feature_group(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.DeleteFeatureGroupRequest, dict]):
                The request object. Request message for
