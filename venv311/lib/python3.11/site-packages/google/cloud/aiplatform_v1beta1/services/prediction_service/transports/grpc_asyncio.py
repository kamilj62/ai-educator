# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/prediction_service/transports/grpc_asyncio.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/prediction_service/transports/grpc_asyncio.py
#
...
=======
    def stream_raw_predict(
        ...
        [prediction_service.StreamRawPredictRequest], Awaitable[httpbody_pb2.HttpBody]
    ]:
...
=======
    ...
    def chat_completions(
        ...
        [prediction_service.ChatCompletionsRequest], Awaitable[httpbody_pb2.HttpBody]
    ]:
