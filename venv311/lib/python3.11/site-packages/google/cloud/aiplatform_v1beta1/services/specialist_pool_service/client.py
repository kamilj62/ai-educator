# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/specialist_pool_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/specialist_pool_service/client.py
#
...
try:
    from .transports.rest_asyncio import AsyncSpecialistPoolServiceRestTransport
...
class SpecialistPoolServiceClient(metaclass=SpecialistPoolServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = (
                SpecialistPoolServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = SpecialistPoolServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or SpecialistPoolServiceClient._compare_universes(
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/specialist_pool_service/client.py
        ...
        self._universe_domain = SpecialistPoolServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, SpecialistPoolServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(SpecialistPoolServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or SpecialistPoolServiceClient._get_api_endpoint(
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/specialist_pool_service/client.py
    ...
    def __enter__(self) -> "SpecialistPoolServiceClient":
        return self
