# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/match_service/transports/grpc_asyncio.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/match_service/transports/grpc_asyncio.py
#
...
class MatchServiceGrpcAsyncIOTransport(MatchServiceTransport):
    """gRPC AsyncIO backend transport for MatchService.
    ...
    def find_neighbors(
        ...
        Returns:
            Callable[[~.FindNeighborsRequest],
                    Awaitable[~.FindNeighborsResponse]]:
    ...
    def read_index_datapoints(
        ...
        Returns:
            Callable[[~.ReadIndexDatapointsRequest],
                    Awaitable[~.ReadIndexDatapointsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
...
__all__ = ("MatchServiceGrpcAsyncIOTransport",)
