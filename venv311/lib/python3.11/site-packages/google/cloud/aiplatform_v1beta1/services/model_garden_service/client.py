# -*- coding: utf-8 -*-
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
# Copyright 2023 Google LLC
=======
# Copyright 2024 Google LLC
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
#
...
try:
    from .transports.rest_asyncio import AsyncModelGardenServiceRestTransport
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ModelGardenServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ModelGardenServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ModelGardenServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or ModelGardenServiceClient._compare_universes(
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
        ...
        self._universe_domain = ModelGardenServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, ModelGardenServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(ModelGardenServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ModelGardenServiceClient._get_api_endpoint(
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
    ...
    def get_publisher_model(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetPublisherModelRequest, dict]):
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
    ...
    def list_publisher_models(
        ...
        *,
        ...
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, str]] = (),
    ) -> pagers.ListPublisherModelsPager:
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListPublisherModelsRequest, dict]):
                The request object. Request message for
...
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
        # Minor optimization to avoid making a copy if the user passes
        # in a model_garden_service.ListPublisherModelsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
=======
        # - Use the request object if provided (there's no risk of modifying the input as
...
>>>>>>> dd7ecbd (added imagen images):backend/venv/lib/python3.9/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_publisher_models]
        ...
        response = pagers.ListPublisherModelsPager(
            method=rpc,
            request=request,
            response=response,
<<<<<<< HEAD:venv311/lib/python3.11/site-packages/google/cloud/aiplatform_v1beta1/services/model_garden_service/client.py
